...
public class JDBCSQLSelect {
    ...
    static public void main(String args[]) {
         ...
         boolean IsCSV = false,
                 HasHeader = false,
                 IsVerbose= false;
         System.out.println("JDBCSQLSelect - Generic JDBC tool for dumping SQL Select statements to fixed-width text and delimited text files");
         ...
         if (args[0].equalsIgnoreCase("/?")) {
              System.out.println("usage: java JDBCSQLSelect [JDBC URL] [JDBC Driver] [DB User] [DB Password] [SQL Query File] [Output Results File] [Is CSV] ");
              System.out.println("                          [Has Header] [Field Delim] [Text Qualifier] [Rows Copied Incre] [Pad Space File] [Is Verbose]");
              ...
              System.out.println("            [SQL Query File]      - Full path for the file containing SELECT SQL statements to execute                                                   ");
              System.out.println("            [Output Results File] - Full path for the output file containing the results either in delimited text or fixed-width text format             ");
              System.out.println("            [Is CSV]              - 'True' if the output file is delimited and 'False' if output file is fixed-width text                                ");
              System.out.println("            [Has Header]          - 'True' if column names will be displayed and 'False' if column names display is suppressed                           ");
              System.out.println("            [Field Delim]         - Delimiter used to separate fields if output file is delimited file; this is typically a comma (,)                    ");
              System.out.println("            [Text Qualifier]      - Text qualifier used in surrounding all fields if output file is delimited file; this is typically a double-quote (\")");
              System.out.println("            [Rows Copied Incre]   - Number used as increment for display in console for the nos. of rows copied                                          ");
              System.out.println("            [Pad Space File]      - Full path for the Pad Spaces Specification File                                                                      ");
              System.out.println("            [Is Verbose]          - 'True' if verbose information such as JDBC driver name and version will be displayed and 'False' if otherwise        ");
              return;
         } 
         JDBCURL           = args[0];
         JDBCdriver        = args[1];
