...
SETLOCAL
SET javaexec=C:\Program Files\Java\jdk1.6.0_01\bin\java
SET servername=localhost
SET DBUser=victoriacourt
SET DBPassword=victoriacourt
SET inputSQLdir=E:\My Documents\walto\Personal Files\WLA Programs\Generic JDBC
SET inputSQLfile=input.txt
SET outputresultsdir=E:\My Documents\walto\Personal Files\WLA Programs\Generic JDBC
SET outputresultsfile=output.txt
SET isCSV=True
SET hasHeader=True
SET databasetype=MySQL
SET fielddelimiter=,
SET textqualifier="
SET rowscopiedincrement=1000
SET padspacedir=E:\My Documents\walto\Personal Files\WLA Programs\Generic JDBC
...
REM ----> MySQL JDBC Settings <-------
:MySQL
SET classpath=.;Drivers\MySQL\mysql-connector-java-5.0.7-bin.jar
...
SET JDBCURL=jdbc:oracle:thin:@//%servername%:1521/%OracleServiceName%
...
SET JDBCURL=jdbc:oracle:thin:@%servername%:1521:%Oracle8ServiceName%
